...
time. An uncalibrated analysis of the same checkpoints reported 3,753.
...
against a harm-relevant contrastive corpus (AdvBench/HarmBench) raised ROC-AUC to
0.643---still modest but now clearly above chance, confirming that the degenerate
