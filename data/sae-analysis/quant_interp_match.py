...
OUT_DIR   = WORKSPACE / "data/quant-interp"
...
ARMS = {
    "bf16": {"ckpt": SAE_DIR / "llama3b-l14-bf16-sae/checkpoint_final.npz",
             "acts": ACTS_DIR / "llama3b-l14-bf16"},
    "q4":   {"ckpt": SAE_DIR / "llama3b-l14-q4-sae/checkpoint_final.npz",
             "acts": ACTS_DIR / "llama3b-l14-q4"},
}
PAIRS = (("bf16", "q4"),)
...
def main() -> None:
    ...
    print("Quantization x interpretability -- bf16 vs locally-converted 4-bit")
    ...
    (OUT_DIR / "quant-interp-report.json").write_text(json.dumps(out, indent=1))
    ...
    print( "  reference: same-model-different-seed 8%; cross-architecture 0.18-0.33%")
