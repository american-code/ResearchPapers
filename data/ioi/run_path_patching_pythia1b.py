"""
IOI Edge-Level Path Patching: Pythia-1.4B
...
# Top-5 heads ranked by activation patching score (patching-pythia1b.json, top-5 by patching score)
TOP5_HEADS = [(10, 7), (15, 15), (22, 2), (21, 3), (12, 15)]
...
class PathPatchableAttention(nn.Module):
    """Drop-in for GPT-NeoX Attention supporting capture and injection modes."""
    ...
    def __init__(self, orig: nn.Module) -> None:
        ...
        self.rope       = orig.rope
        self.n_heads    = orig.num_attention_heads
    ...
    def __call__(
        ...
        qkv = self.query_key_value(x).reshape(B, L, self.n_heads, 3 * self.head_dim)
...
def main() -> None:
    ...
    out_path = DATA_DIR / "path-patching-pythia1b-real.json"
